...
:::
### A Collaboration
A team from the K. Lisa Yang Center for Conservation Bioacoustics led by Dr. Aaron Rice will investigate the temporal and spatial patterns of cetacean habitat and underwater noise levels in the Maryland Wind Energy Area. Additionally, the team from Cornell will also conduct one of the first before-, during- and after-construction analyses of whale occurrence as it relates to wind farm construction. To learn more about the Yang center: [https://www.birds.cornell.edu/ccb/](https://www.birds.cornell.edu/ccb/)
...
<audio controls source src="../audio/Right-whale_Amplified.mp3">
...
![](images/logos/UMCESlogo.png){width="2in"} ![](images/logos/USWindlogo.png){width="2in"}
![](images/logos/Helenslogo.png){width="1.25in"}
![](images/logos/Cornell Insignia.jpg){width=1in}
![](images/logos/Cornelllogo.png){width=2in} 
